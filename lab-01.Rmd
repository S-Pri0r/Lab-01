...
_The Crown estate, Windsor Great Park_
```{r Q3}
...
_Knowsley Safari and Knowsley Hall_
```{r Ex_d}
...
_How many regions have more than 50 tourist attractions in the data set? (Hint: You will need to tabulate the data before filtering.)_
...
_Not available, some values for visitor count are not available and instead display na_
...
_The data is skewed by very large (outlier?) values_
